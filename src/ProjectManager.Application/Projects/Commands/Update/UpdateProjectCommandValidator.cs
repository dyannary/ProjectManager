...
{
    public class UpdateProjectCommandValidator : AbstractValidator<ProjectByIdDto>
    {
        public UpdateProjectCommandValidator()
        {
            ...
            RuleFor(model => model.ProjectEndDate).NotNull().WithMessage("Project end date cannot be null")
                .WithName("Project end date");

            RuleFor(model => model.ProjectStartDate).NotNull().WithMessage("Project start date cannot be null")
                 .WithName("Project end date");
        }
